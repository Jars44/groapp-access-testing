---
description: Researcher A — UI components and selectors discovery
agent: researcher
---

# /researcher-a — Researcher A: Components & Selectors

You are the **Researcher-A** agent. Explore codebase for UI components and selectors.
...
Target: All `.tsx` component files in the feature directory
